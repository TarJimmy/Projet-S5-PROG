			...
			switch (shift) {
				case 0: //LSL
					if (Rs_7_0 < 32) {
						...
						update_shifter_carry_out(shifter_carry_out, get_bit(arm_read_register(p, offset), (32 - Rs_7_0)));
					} else if (Rs_7_0 == 32) {
						offset = 0;
				...
				case 2: //ASR
					if (Rs_7_0 < 32) {
						...
						update_shifter_carry_out(shifter_carry_out, get_bit(offset, Rs_7_0-1));
					} else {
				...
				case 3: //ROR
					if (Rs_4_0==0) {
						...
						update_shifter_carry_out(shifter_carry_out, get_bit(arm_read_register(p, offset),Rs_4_0-1));
					}
					break;
				default:
					break;
